...
convenient for teaching. Examples of triples include `["Minhocão", "is", "an
earthworm"]` and `["Minhocão", "eats", "horses"]`. In the first, `"Minhocão"` is
