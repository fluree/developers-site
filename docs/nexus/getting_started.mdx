...
Adding data in Fluree Nexus can be done on the transact page of your dataset. All transactions need to be nested in square brackets `[]`. Transactions are wrtitten in FlureeQL.
