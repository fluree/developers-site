...
when joining the waitlist. If you have not joined the waitlist and wish to register to use Fluree Nexus navigate to either [http://www.flur.ee/nexus](http://www.flur.ee/nexus) or [http://www.flur.ee/try](http://www.flur.ee/try).
