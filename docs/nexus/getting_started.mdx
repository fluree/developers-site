...
when joining the waitlist. If you have not joined the waitlist and wish to register to use Fluree Nexus navigate to either [flur.ee/nexus](http://www.flur.ee/nexus) or [flur.ee/try](http://www.flur.ee/try).
...
For more information about transacting in Fluree Nexus refer to the [transact page](https://developers.flur.ee/docs/nexus/dataset-pages/transact/) and the [transaction basics](https://developers.flur.ee/docs/overview/transact/basics/) fluree documentation.
