...
Before you can proceed connecting an application to nexus you will two key details that are found in the [connect page](https://developers.flur.ee/docs/dataset-pages/connect/) of your dataset.
...
1. You can either sign your queries and transactions programmatically as detailing in the [developer portal](https://developers.flur.ee/docs/concepts/identity/signatures/#signed-queries).
