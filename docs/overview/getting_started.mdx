...
> Please note that there are multiple ways of installing Fluree e.g. Java, [Docker](https://developers.flur.ee/docs/overview/getting_started/#docker), [Homebrew](https://developers.flur.ee/docs/overview/getting_started/#homebrew)
