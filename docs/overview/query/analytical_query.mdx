...
| [two-tuple variable binding](#two-tuple-variable-binding) | Bind a variable to a value, including to a calculated aggregate value. These variables can be used in subsequent where-array items.                                                                                                         |
...
| [filter map](#filter-map)                                 | Filters the results up to that point in the query.                                                                                                                                                                                           |
