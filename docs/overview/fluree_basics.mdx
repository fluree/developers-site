...
For example, the person collection might have the following predicates: `person/firstName`, `person/lastName`, and `person/age`. The value of those predicates are called objects. You can read more about the [subject-predicate-object model](/concepts/technical_overview.md#subject-predicate-object-model) if you would like to get a deeper understanding of how RDF works in Fluree.
