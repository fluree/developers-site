...
Below are the built-in predicates for the `_collection` collection. As mentioned above, you can add additional predicates if you wish.
...
| `_collection/spec`    | [`ref`]  | (optional) A multi-cardinality list of reference to the `_fn` collection. These specs restrict what is allowed in this collection. To see how to write a function, see the [function section](/overview/schema/smartfunctions.mdx). |
