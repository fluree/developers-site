...
To test these rules, you will need to submit signed queries and transactions. You can do this either through the user interface or through the API. More information is in the [signatures section](/concepts/identity/signatures.md).
...
[
  {
    ...
    "person/favNums": [-1, 5, 28, 645, 1223],
    "person/favArtists": [
      {
        "_id": 404620279021569
      }
