...
2\. Concept Mappings can also be changed for existing rules, and this can be done through the **Applied Mappings** tab. We’ll cover this in detail in a [different section](/docs/sense/Classify%20Module/Data%20Quality%20Rules/rule-applied-columns/index.md).
