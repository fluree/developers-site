...
![](images/45_view_catalog_1.png)

A user can view:

1. The Name and Description of each _Catalog_.

3. The last time the _Catalog_ was updated, and who created it.

5. The number of Objects that the _Catalog_ contains.

7. The number of _Concepts_ that the _Catalog_ contains.

9. The number of Data Sources mapped to each _Catalog_.

11. The number of High Confidence datasets mapped to each _Catalog_.

13. The number of High Confidence Dataset Columns mapped to each _Catalog_.

15. The no. of Data Quality Rules for that _Catalog_ and the Data Quality Score as well.
