...
module.exports = {
	...
	SenseSidebar: [
		"sense/index",
		{
			...
			items: [{ type: "autogenerated", dirName: "sense/Getting Started" }],
		},
		{
			type: "category",
			label: "Classify Module",
			items: [{ type: "autogenerated", dirName: "sense/Classify Module" }],
		},
		{
			type: "category",
			label: "Resolve Module",
			items: [{ type: "autogenerated", dirName: "sense/Resolve Module" }],
		},
		{
			type: "category",
			label: "Ingest",
			items: [{ type: "autogenerated", dirName: "sense/Ingest" }],
		},
	],
	learn: [
		"learn/overview",
