...
module.exports = {
	...
	// Review-only sidebar for the FlureeSense Practitioner Playbook.
	// Pages stay `unlisted: true` (noindex, excluded from search + sitemap)
	// and this sidebar is intentionally NOT wired into the navbar, so it is
	// only seen by reviewers who open a playbook link directly.
	flureesensePlaybook: [
		{
			type: "autogenerated",
			dirName: "sense/flureesense-playbook-task-library/docs",
		},
	],
	"getting-started": [
